...
activities = {
    ...
    "Art Club": {
        "description": "Creative workshops in painting, drawing, and mixed media",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ava@mergington.edu", "jack@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, script reading, and stage production rehearsals",
    ...
    "Debate Team": {
        "description": "Develop persuasive speaking and argumentation skills",
